...
def process_annotated_json(class_names, filename, output_dir, label_dict):
    ...
    except labelme.label_file.LabelFileError:
        print(filename)
        return
...
def main():
    ...
    parser.add_argument("--json_dir", default='C:\\Users\\xld77\\OneDrive\\桌面\\data\\Tea\\MT3D\\MT3D\\fall', help="input annotated directory")
    parser.add_argument("--output_dir", default='C:\\Users\\xld77\\OneDrive\\桌面\\data\\Tea\\MT3D\\NewMT3D\\fall', help="output dataset directory")
    parser.add_argument("--labels", default='C:\\Users\\xld77\\OneDrive\\桌面\\data\\Tea\\MT3D\\MT3D\\fall\\label_names.txt', help="labels file")
    parser.add_argument("--label_dict", default= 'C:\\Users\\xld77\\OneDrive\\桌面\\data\\Tea\\MT3D\\MT3D\\fall\\label_dict.txt', help="convert label with dict")
