...
def detect(list_pts_blue, list_pts_yellow, yaml, weights, yolo, classify_id, video_path, output):
    ...
    list_pts_blue = [[204, 305], [227, 431], [605, 522], [1101, 464], [1900, 601], [1902, 495], [1125, 379], [604, 437],
                     [299, 375], [267, 289]]
    # 1920 - 1080
    # list_pts_blue = [[0, 1000],  [1920, 1000], [1920, 980], [0, 980]]
    ...
    list_pts_yellow = list_pts_yellow
    ...
    while True:
        ...
        pass
    Tea_sum = current_nums + down_count
    print(f"当前影像中的茶叶数目为：{Tea_sum}")
